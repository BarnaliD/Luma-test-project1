    ...
    context('I choose my size and then sort products by price ',() => {
        it('I can see products in required size and ascending order of prices on product page', async () => {
            ...
            try {
                ...
                await driver.wait(until.elementLocated(By.css('.more.button')),20000);
                await driver.findElement(By.css('.more.button')).click();
                await driver.sleep(10000);
                await driver.findElement(By.xpath('/html/body/div[1]/main/div[3]/div[2]/div/div[2]/div/div[3]')).click();
               
                //Select size M
                await driver.wait(until.elementLocated(By.css('.swatch-option-link-layered>div[option-id="168"]')),20000);
